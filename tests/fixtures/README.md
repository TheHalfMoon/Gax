...
The `synthetic_signal` values are abstract test inputs with no medical unit,
clinical threshold, or patient-care meaning. They exist only to exercise schema,
probability, calibration, selective-risk, and abstention code paths.
